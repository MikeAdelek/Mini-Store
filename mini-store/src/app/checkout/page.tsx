              ...
              <div className="bg-white shadow-sm rounded-lg p-6">
                ...
                <form onSubmit={handleShippingSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors disabled:opacity-50"
                  >
                    Continue to Payment
                  </button>
                </form>
