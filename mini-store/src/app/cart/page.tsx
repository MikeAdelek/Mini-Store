          ...
          <section className="mt-16 bg-white rounded-lg shadow-sm p-6 lg:mt-0 lg:col-span-5">
            ...
            <div className="mt-6 space-y-3">
              <button
                ...
                className="w-full bg-teal-600 text-white py-3 px-4 rounded-md font-medium hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
              >
                Proceed to Checkout
              </button>
              ...
              <button
                ...
                className="w-full bg-gray-100 text-gray-900 py-3 px-4 rounded-md font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200"
              >
                Continue Shopping
              </button>
            </div>
